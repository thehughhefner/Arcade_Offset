...
# Arcade Offset parameters:
export DEFAULT_DB_ID="arcade_offset_folder"
export DEFAULT_DB_URL="https://raw.githubusercontent.com/atrac17/Arcade_Offset/db/arcadeoffsetdb.json.zip"

if ! "${SCRIPT_PATH}" ; then
    echo -e "Arcade Offset failed!\n"
    exit 1
fi
