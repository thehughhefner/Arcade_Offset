...
curl -s --insecure https://raw.githubusercontent.com/atrac17/Arcade_Offset/main/release/misterfpga_arcade_offset-20210706.txz | tar -Jxf - --no-same-owner --no-same-permissions &&
echo 
